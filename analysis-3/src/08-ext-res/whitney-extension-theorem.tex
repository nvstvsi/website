...
Following the example above, we can think of $f^{(0)}$ as the ``original'' function which we are trying to extend, and for each multi-index $\alpha$ with $1 \leq |\alpha| \leq m$, 
...
The next three exercises may seem like you are just pushing symbols around, but all of these properties will be used in the proof of the Whitney's Extension Theorem.
