...
\end{lemma}
    ...
    \begin{proof}
        ...
        see that for each $t \geq 0$, the set $\{ s : (t,s) \in \operatorname{conv}(\rho) \}$ is a closed (possiby degenerate) interval of the form $[0,\omega(t)]$ for some $\omega(t) \geq \rho(t) \geq 0$.
...
\begin{proof}[Proof of Whitney's $C^m$ Extension Theorem in the case $A \subset \R^n$ is compact]
    ...
    Now we fix an cube $Q\subset \R^n$ such that $A \subset Q$ for the rest of the proof.
